...
|---|-----|-----------|--------|
| A | **Тестирование текущего варианта:** прогнать setup.sh на чистой среде (другой аккаунт / sandbox), проверить что все placeholder-ы подставляются, launchd грузится, my-strategy создаётся | high | 45 мин |
